...
const SearcherCombo = ({
    ...
    return (
      <>
        <label htmlFor="printer" className="block p-2 text-primary-500">
          ¿Qué tipo de impresora 3D quieres?
        </label>
        <select
          className="p-2 text-white bg-transparent border border-white rounded-md"
          name="printer"
          value={printerType}
          onChange={(event) => setPrinterType(event.currentTarget.value)}
        >
    ...
    return (
      <>
        <label htmlFor="filament" className="block p-2 text-primary-500">
          ¿Qué tipo de filamento estás buscando?
        </label>
        <select
          className="p-2 text-white bg-transparent border border-white rounded-md"
          name="filament"
          value={filamentType}
          onChange={(event) => setFilamentType(event.currentTarget.value)}
        >
        ...
        <select
          ...
          name="filament"
          value={filamentColor}
          onChange={(event) => setFilamentColor(event.currentTarget.value)}
        >
    ...
    return (
      <>
        ...
        <select
          ...
          name="resina"
          value={resinColor}
          onChange={(event) => setResinColor(event.currentTarget.value)}
        >
    ...
    return (
      <>
        ...
        <select
          ...
          name="accesorios"
          value={accesorio}
          onChange={(event) => setAccesorio(event.currentTarget.value)}
        >
    ...
    return (
      <>
        <label htmlFor="postprocesado" className="block p-2 text-primary-500">
          ¿Qué postprocesado estás buscando?
        </label>
        <select
          className="p-2 text-white bg-transparent border border-white rounded-md"
          name="postprocesado"
          value={postprocesado}
          onChange={(event) => setPostprocesado(event.currentTarget.value)}
        >
  ...
  const getUrl = () => {
    return `${withPrefix('/')}qp?s=${base64Encode(
      transformProduct().toLowerCase()
    )}`
  }
  ...
  return (
    <div
      id="searcherCombo"
      className="flex justify-center w-full bg-gradient-to-r from-secondary-300 via-secondary-600 to-secondary-900"
    >
          ...
          <div className="w-full p-2">
            {useAsTitle ? (
              <>
                ...
                <h2 className="block text-xl text-center font-extralight md:text-2xl lg:text-3xl">
                  {subtitle}
                </h2>
              </>
            ) : (
              <>
                ...
                <h3 className="block text-xl text-center font-extralight md:text-2xl lg:text-3xl">
                  {subtitle}
                </h3>
              </>
            )}
            <div className="flex flex-col p-2">
              ...
              <Link
                to={getUrl()}
                className="p-2 m-6 text-2xl text-center text-white rounded-md cursor-pointer bg-primary-500 hover:bg-primary-700 focus:bg-primary-700"
              >
                Ver {product}
              </Link>
            </div>
