...
customSections:
  ...
  - showBorder: false
    ...
    sectionContent: >-
      ...
      <h3 class="text-primary-500 font-bold py-5">Diseño, formato y estructura</h3>
      ...
      <h3 class="text-primary-500 font-bold py-5">Sensor de filamento</h3>
      ...
      <h3 class="text-primary-500 font-bold py-5">Electrónica</h3>
      ...
      <h3 class="text-primary-500 font-bold py-5">Cama caliente</h3>
      ...
      <h3 class="text-primary-500 font-bold py-5">Calidad de materiales y agilidad</h3>
      ...
      <h3 class="text-primary-500 font-bold py-5">Precio</h3>
...
whereBuy:
  ...
  whereBuyText: >-
    <h3 class="text-primary-500 font-bold py-3 text-xl text-center">Amazon</h3>

    <p>Puedes encontrar esta impresora en la tienda oficial de Amazon de la marca Artillery.</p>

    <h3 class="text-primary-500 font-bold py-3 text-xl text-center">Aliexpress</h3>

    <p>La propia marca de Artillery también tiene tienda en Aliexpress, por lo que también la puedes encontrará aquí.</p>

    <h3 class="text-primary-500 font-bold py-3 text-xl text-center">La tienda de Artillery</h3>
