...
const initialCategories = [
  {
    ...
    description:
      'Piérdele el miedo a la impresión 3D y aprende todo lo que necesitas saber para empezar en este mundo y convertirte en un verdadero maker.',
  ...
  },
  {
    ...
    description:
      'En esta guía encontrárás las mejores impresoras 3D que puedes comprar para empezar en la impresión 3D.',
...
const printersCategory = [
  {
    ...
    description:
      'En esta guía encontrarás lo que necesitas para empezar a hacer impresiones 3D a lo grande.',
  ...
  },
  {
    ...
    description:
      '¿Quieres montar un negocio de impresión 3D?, accede a esta guía de impresión 3D profesional.',
  ...
  },
  {
    ...
    description:
      'Si te gusta cacharrear con los cables esta es tu sección, en esta guía te enseñamos como funcionan.',
    route: '/impresoras-3d-profesionales',
...
const resinCategory = [
  {
    ...
    description:
      '¿Quieres empezar a imprimir con resina? En esta guía te contamos todo lo necesario.',
  ...
  },
  {
    ...
    description:
      'Encuentra aquí una guía con las mejores guías del mercado para hacer tus impresiones con resina.',
    route: '/resina-3d',
...
const filamentCategory = [
  ...
  },
  {
    name: 'Filamento PETG',
    description:
      'Has probado el filamento PETG? Aquí te enseñamos en que consiste y cual comprar',
  ...
  },
  {
    name: 'Filamento TPU',
    description:
      '¿Quieres probar algo nuevo? Aquí te ofrecemos filamento TPU, descubre este filamento tan chulo',
    route: '/filamento-tpu',
  ...
  return (
    ...
    >
      ...
      <section className="flex justify-center w-full p-8 border-b bg-blueGray-200 border-blueGray-300">
        <div className="flex flex-col justify-between w-full md:w-4/5 text-blueGray-500">
          ...
          <h3 className="block text-xl text-center font-extralight md:font-thin lg:text-2xl text-blueGray-400">
            Nos preocupamos por que cada persona pueda disfrutar de impresiones
            3D únicas.
          </h3>
          <p className="my-2 text-center">
            Sabemos que la impresión 3D es un mundo bastante extenso, con muchas
            particularidades, por eso,{' '}
            <b>
              comprar una impresora 3D en muchas ocasiones no es una tarea nada
              sencilla
            </b>
            , no te preocupes, te acompañaremos de la mano para ayudarte a
            encontrar la impresora 3D que buscas en función de lo que necesites.
          </p>
          <p className="my-2 text-center">
            ¿Y como vais a hacer eso? te preguntarás, muy sencillo,{' '}
            <b>
              hemos preparado para tí estas guías adaptadas con toda la
              información que necesitas en cada uno de los casos
            </b>
            , para que sepas bien en que aspectos debes fijarte en función del
            tipo de impresora que estés buscando, tamaño, calidad, precio... .
          </p>
        </div>
      </section>
      <section className="flex justify-center w-full p-8">
        <div className="flex flex-col justify-between w-full md:w-4/5 text-blueGray-500">
          ...
          <p className="block text-xl text-center font-extralight md:font-thin lg:text-2xl text-blueGray-400">
            ...
            enseñamos todo lo necesario para empezar.
          </p>
      ...
      <section className="flex justify-center w-full p-8">
        <div className="flex flex-col justify-between w-full md:w-4/5 text-blueGray-500">
          <h2 className="p-2 text-2xl font-light text-center md:font-extralight lg:text-3xl text-primary-500">
            ¿Ya tienes experiencia en la impresión 3D y quieres dar un pasito
            más?
          </h2>
          <p className="block text-xl text-center font-extralight md:font-thin lg:text-2xl text-blueGray-400">
            Aquí puedes encontrar unas guías que hemos elaborado para tí en
            función del tipo de impresora que estés buscando.
          </p>
      ...
      <section className="flex justify-center w-full p-8">
        <div className="flex flex-col justify-between w-full md:w-4/5 text-blueGray-500">
          ...
          <p className="block text-xl text-center font-extralight md:font-thin lg:text-2xl text-blueGray-400">
            No te preocupes, te ayudamos a que puedas elegir el tipo de
            filamento que necesitas.
          </p>
      ...
      <section className="flex justify-center w-full p-8">
        <div className="flex flex-col justify-between w-full md:w-4/5 text-blueGray-500">
          ...
          <p className="block text-xl text-center font-extralight md:font-thin lg:text-2xl text-blueGray-400">
            Si te gusta imprimir con resina, o no lo has probado todavía pero te
            gustaría, en este apartado encontrarás lo que necesitas.
          </p>
      ...
      <section
        id="searcherCombo"
        className="flex justify-center w-full p-8 border-b bg-blueGray-200 border-blueGray-300"
      >
        <div className="flex flex-col justify-between w-full md:w-4/5 text-blueGray-500">
          <h2 className="p-2 text-2xl font-light text-center md:font-extralight lg:text-3xl text-primary-500">
            Últimas reviews de impresoras 3D
          </h2>
          <p className="block text-xl text-center font-extralight md:font-thin lg:text-2xl text-blueGray-400">
            ¿Quieres conocer más en profundidad alguna impresora? Aquí puedes
            ver las últimas reviews de impresoras
          </p>
