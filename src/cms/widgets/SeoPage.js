    ...
    <>
      ...
      <div style={wrapper}>
        <div className="flex justify-end">
          <button
            disabled={!value.name}
            className={`p-2 mx-1 border rounded-md hover:bg-blueGray-600 hover:text-white focus:bg-blueGray-600 focus:text-white ${
              !value.name ? 'opacity-50 cursor-not-allowed' : ''
            }`}
        ...
        <label>
          ...
          <input
            name="name"
            type="text"
            className="css-83wr9v focus:border-blue-600"
            value={value.name}
        ...
        <label>
          ...
          <textarea
            ...
            className="css-wesa1q-TextControl"
            onChange={changeInput}
          />
